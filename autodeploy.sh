...
usage(){
    ...
    echo "Usage : $0 -p <project_type> -j <java_version> -r <repo> -b <branch> -jv <Java_version> -nj
    ...
    Java_version: Specifies which version of Java to Use for deployment
    nj: Specifies if its a non java project"
}
